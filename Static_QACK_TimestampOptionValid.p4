...
parser MyParser(packet_in packet,
    ...
    state parse_payload{
        ...
        bit<32> payload_extract_size = ((bit<32>)(hdr.ipv4.totalLen - ipv4_ihl_bytes - tcp_hdr_bytes)) * 8;
...
control MyIngress(inout headers hdr,
    ...
    apply {
        if(hdr.ipv4.isValid()){
            ...
            if((bit<10>)tmp == 0 && hdr.ipv4.totalLen > 1024 && hdr.ipv4.dstAddr == 0x0a000202){
